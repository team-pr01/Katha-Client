    ...
    return (
      <div className="flex flex-col gap-2 font-Nunito" ref={dropdownRef}>
        ...
        <div className="relative">
          <button
            type="button"
            className={`w-full px-4 py-3.5 rounded-lg  border leading-4.5 focus:outline-none focus:border-primary-10 transition duration-300 text-left flex items-center justify-between cursor-pointer ${
          ...
          {isOpen && (
            ...
            >
              {/* Search input */}
              <div className="sticky top-0 bg-white p-2 border-b border-neutral-50">
                <input
                  type="text"
                  placeholder="Search..."
                  className="w-full px-3 py-2 text-sm border border-neutral-50 rounded-md focus:outline-none focus:border-primary-10"
                  value={searchTerm}
