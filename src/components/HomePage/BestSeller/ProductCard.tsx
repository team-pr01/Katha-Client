  ...
  return (
    <div className="rounded-lg">
      <div className="relative rounded-lg">
        <img src={IMAGES.wedding} alt="" className="rounded-lg w-full h-55 object-cover" />
      ...
      <div className="mt-2">
        <h3 className="font-semibold text-neutral-5">
          The Jewel embedded Brass elephant
        </h3>

        <div className="flex items-center gap-1">
          <img src={ICONS.star} alt="" />
          <p className="mt-2 text-xs text-neutral-10 uppercase flex items-center gap-2">
            4.5 (13)
            <span>|</span>
            <span>1K+ Sold</span>
          </p>
